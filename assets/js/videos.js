/* =====================================================
   videos.js — карточки в стиле книг, плеер внутри
   ===================================================== */
...
async function loadVideos() {
    ...
    try {
        ...
        if (videos && videos.length > 0) {
            ...
            container.innerHTML = '<p style="text-align:center;opacity:0.7;">Brak wideo do wyświetlenia.</p>';
        }
    } catch (err) {
...
function createVideoCard(video, index) {
    ...
    /* iframe — внутри того же блока, скрыт */
